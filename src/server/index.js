...
// this is at the top to avoid dist-client/index.html from being served for home page route
...
function serveReactApp (req, res) {
  ...
  const htmlTemplate = fs.readFileSync(path.resolve(__dirname, '../../dist-client/index.html'), 'utf-8')

  // inject the server-side rendered HTML and client-side JS into the template (i.e., index.html from dist-client folder)
